...
class CohortProcessor():
    ...
    #
    def process_feature_track(self, fname_slp, interpolate_flag):
    ...
    def process_huddle_track(self, fname_slp,
        ...
        fname_out = fname_slp[:-4]+'_multi_track_huddles.npy'
        if os.path.exists(fname_out) and (overwrite_flag==False):
            return
    ...
    def preprocess_huddle_tracks(self):
        ...
        if self.parallel:
            ...
            for fname_slp in tqdm(fnames_slp, desc='processing huddle tracks'):
    ...
    def preprocess_feature_tracks(self):
        ...
        if self.parallel:
            ...
            for fname_slp in tqdm(fnames_slp, desc='processing feature tracks'):
